...
export const buildTargetPoints = (options: AutoEqV3Options): FrequencyPoint[] => {
...
export const alignTargetToMeasurement = (
  ...
  const levelOffsetDb = median(referenceErrors.length > 0 ? referenceErrors : fallbackErrors);
