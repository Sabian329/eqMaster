			...
			<Card.Body {...panelStyles.body}>
				<Stack gap={6}>
					<Tabs.Root
						...
						fitted
					>
						<Tabs.List {...tabStyles.list}>
							<Tabs.Trigger value="simple" {...tabStyles.trigger}>
								Simple
							</Tabs.Trigger>
							<Tabs.Trigger value="advanced" {...tabStyles.trigger}>
								Advanced
							</Tabs.Trigger>
						</Tabs.List>
						...
						<Tabs.Content value="simple" pt={5}>
							<Stack gap={6}>
								...
								<Field.Root>
									...
									<FormHelper>
										Select the speaker channel you want to measure in this run.
									</FormHelper>
								</Field.Root>
							...
							<Stack gap={5}>
								...
								<Field.Root>
									<Flex justify="space-between" align="center" mb={2}>
										<FormLabel>Sweep digital level</FormLabel>
									...
									<FormHelper>
										This is not an SPL level — it depends on your interface,
										amp, and monitors.
									</FormHelper>
								</Field.Root>
